...
public class MainPage extends BasePage {
    ...
    public MainPage closeKarteBanner() {
        log.debug(String.format("Attempt to click element by locator: "), TOP_TOOLBAR.toString());
        driver.findElement(TOP_TOOLBAR).click();
        return this;
    }

    public CouponsPage openCouponsPage() {
        log.debug(String.format("Attempt to click element by locator: "), COUPON_BUTTON.toString());
